...
**Docs:** [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) (as-built components, protocols, data flows). [docs/API_REFERENCE.md](docs/API_REFERENCE.md) (HTTP routes, auth actions, error envelopes). [docs/COMPATIBILITY.md](docs/COMPATIBILITY.md) (REST, gRPC, CLI, config, schema compatibility). [docs/CONFIGURATION.md](docs/CONFIGURATION.md) (environment variables, flags, discovery). [docs/GLOSSARY.md](docs/GLOSSARY.md) (terms). [docs/MIGRATIONS.md](docs/MIGRATIONS.md) (schema change rules and checklist). [docs/RETENTION.md](docs/RETENTION.md) (cleanup policy, CLI, storage pressure metrics). [docs/RUNBOOKS.md](docs/RUNBOOKS.md) and [docs/REPAIR_RUNBOOKS.md](docs/REPAIR_RUNBOOKS.md) (alerts, triage, repair recipes). [docs/PLANNING.md](docs/PLANNING.md) (§1 goals and deploy posture; §2+ roadmap and target vs shipped). [docs/FAILURE_DOMAINS.md](docs/FAILURE_DOMAINS.md) (dependency outages, expectations, current behavior). Deferred multi-site notes: [docs/FEDERATION.md](docs/FEDERATION.md). **ADRs** (design decisions): [docs/adr/README.md](docs/adr/README.md). **Security posture:** [docs/SECURITY.md](docs/SECURITY.md). **Contributing:** [CONTRIBUTING.md](CONTRIBUTING.md).
