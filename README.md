...
**Docs:** [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) (as-built components, protocols, data flows). [docs/PLANNING.md](docs/PLANNING.md) (roadmap, target vs shipped). [docs/FAILURE_DOMAINS.md](docs/FAILURE_DOMAINS.md) (dependency outages, expectations, current behavior). Deferred multi-site notes: [docs/FEDERATION.md](docs/FEDERATION.md). **Contributing:** [CONTRIBUTING.md](CONTRIBUTING.md).
