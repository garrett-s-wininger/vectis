...
| Goal | Setting |
| --- | --- |
| Avoid registry dial/registration on dependent startup | Pin queue/log addresses with the role-specific discovery variables in [CONFIGURATION.md](CONFIGURATION.md#service-discovery-vs-fixed-addresses). |
