...
const file_registry_proto_rawDesc = "" +
	...
	"\x0fCOMPONENT_QUEUE\x10\x012;\n" +
	"\x0fRegistryService\x12(\n" +
	"\bRegister\x12\r.Registration\x1a\r.common.EmptyB$B\rRegistryProtoP\x01Z\x11vectis/api/gen/gob\beditionsp\xe8\a"
...
var file_registry_proto_depIdxs = []int32{
	...
	1, // 1: RegistryService.Register:input_type -> Registration
	2, // 2: RegistryService.Register:output_type -> common.Empty
