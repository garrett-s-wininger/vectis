...
| `vectis-ui` | `VECTIS_UI` | static UI server + browser BFF; default host `localhost`, default port `8089`, serves embedded UI unless `VECTIS_UI_DIR` overrides; manages UI session cookies and proxies `/api/` to `VECTIS_UI_API_URL` |
