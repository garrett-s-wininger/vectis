...
func init() {
	...
	configureDeployLinuxVerifyFlags(deployLinuxVerifyCmd, true)
	configureDeployLinuxBackendFlags(deployLinuxCleanCmd, true)
	configureDeployLinuxBackendFlags(deployLinuxDownCmd, true)
	configureDeployLinuxBackendFlags(deployLinuxDeleteCmd, true)
	deployLinuxCmd.AddCommand(deployLinuxRenderCmd)
	deployLinuxCmd.AddCommand(deployLinuxVerifyCmd)
	deployLinuxCmd.AddCommand(deployLinuxCleanCmd)
	deployLinuxCmd.AddCommand(deployLinuxDownCmd)
	deployLinuxCmd.AddCommand(deployLinuxDeleteCmd)
