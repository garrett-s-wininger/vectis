...
**As-built** architecture: [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md). **Configuration** (env, flags): [docs/CONFIGURATION.md](docs/CONFIGURATION.md). **Glossary:** [docs/GLOSSARY.md](docs/GLOSSARY.md). Large design decisions and **target vs shipped** behavior are documented in [docs/PLANNING.md](docs/PLANNING.md). Prefer updating PLANNING (or [docs/FEDERATION.md](docs/FEDERATION.md) for deferred multi-site material) instead of duplicating long design text in this guide; keep topology/protocol details in ARCHITECTURE when they change.
