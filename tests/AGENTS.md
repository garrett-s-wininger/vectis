...
| `VECTIS_E2E_PACKAGE_SERVICES_DEB` | Path to a built `vectis-services` DEB for package e2e testing. |
| `VECTIS_E2E_PACKAGE_SERVICES_RPM` | Path to a built `vectis-services` RPM for package e2e testing. |
