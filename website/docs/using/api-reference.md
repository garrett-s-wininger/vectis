...
| GET | `/api/v1/reconciler/stuck-runs` | Count of stuck root-dispatch queued runs plus pending task continuation dispatch intents, including per-cell counts when available | Public | none | `200` JSON stuck runs |
