...
| GET | `/api/v1/runs/{id}` | Get one run, including audit metadata, dispatch events, and task completion summary when present | `run:read` | general | `200` JSON run |
