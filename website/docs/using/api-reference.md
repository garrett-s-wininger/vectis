...
| POST | `/api/v1/source-repositories/{id}/sync` | Probe a source repository checkout and persist sync status/evidence | `job:write` | general | `200` JSON repository |
