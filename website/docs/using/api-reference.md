...
| DELETE | `/api/v1/source-repositories/{id}` | Delete an unused source repository registration without removing checkout files | `job:write` | general | `204` empty; `409` when source schedules or source provenance reference the repository |
