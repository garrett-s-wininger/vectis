...
| Bind private cell ingress to another interface | `VECTIS_CELL_INGRESS_HOST=0.0.0.0` plus a matching static endpoint or `VECTIS_CELL_INGRESS_ALLOWED_HOSTS=<ingress-host>` |
