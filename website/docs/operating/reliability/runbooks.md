...
| Secret resolution failures | Secret broker logs, `outcome`, `reason`, `provider`, SPIFFE SVID checks, policy rules, encryptedfs root/key. | [Secret Resolution](./repair-runbooks.md#secret-resolution) |
