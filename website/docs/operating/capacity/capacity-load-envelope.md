...
| Increase task fan-out | Validate queue handoff rate, `vectis_task_dispatch_intents_total`, `vectis_task_dispatch_pending_intents`, dispatch event volume, database write load, and retention before relying on very wide or deep DAGs. |
