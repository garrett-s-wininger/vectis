...
- **Mental model:** Operators must reason about **both** queue health (backlog, persistence, TTL) and **database** health (claims, leases) when debugging stuck or duplicate-looking behavior ([FAILURE_DOMAINS.md](../../concepts/failure-domains.md)).
