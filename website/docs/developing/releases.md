...
| Capacity-sensitive | API hot path, queue, orchestrator, worker, log streaming, cron, SCM poller, reconciler, catalog, or database query path changed. | Include performance evidence or explain why no check was needed. |
