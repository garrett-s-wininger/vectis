...
func TestSQLiteMigrations_UpDownRoundTrip(t *testing.T) {
	...
	assertTableExists(t, db, "scm_poll_trigger_specs")
	assertTableExists(t, db, "scm_trigger_events")
	...
	assertTableMissing(t, db, "scm_poll_trigger_specs")
	assertTableMissing(t, db, "scm_trigger_events")
