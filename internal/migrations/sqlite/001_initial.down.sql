...
DROP INDEX IF EXISTS idx_run_hot_state_owners_lease_until;
DROP INDEX IF EXISTS idx_run_hot_state_owners_cell_owner;
...
DROP INDEX IF EXISTS idx_scm_trigger_events_run_id;
...
DROP INDEX IF EXISTS idx_reaction_invocations_event;
DROP INDEX IF EXISTS idx_reaction_invocations_claims;
DROP INDEX IF EXISTS idx_reaction_invocations_ready;
DROP INDEX IF EXISTS idx_reaction_subscriptions_event;
DROP INDEX IF EXISTS idx_reaction_subscriptions_target;
DROP INDEX IF EXISTS idx_reaction_subscriptions_global_name;
DROP INDEX IF EXISTS idx_reaction_targets_enabled;
DROP INDEX IF EXISTS idx_reaction_targets_kind;
DROP INDEX IF EXISTS idx_reaction_targets_global_name;
DROP INDEX IF EXISTS idx_reaction_events_namespace_created;
DROP INDEX IF EXISTS idx_reaction_events_job_created;
DROP INDEX IF EXISTS idx_reaction_events_run_created;
DROP INDEX IF EXISTS idx_reaction_events_type_created;
DROP INDEX IF EXISTS idx_trigger_invocations_job_created;
DROP INDEX IF EXISTS uidx_cron_schedule_id;
DROP INDEX IF EXISTS idx_scm_poll_provider_project;
DROP INDEX IF EXISTS idx_scm_poll_claimed_until;
DROP INDEX IF EXISTS idx_scm_poll_next_poll;
...
DROP INDEX IF EXISTS idx_run_task_final_facts_execution;
DROP INDEX IF EXISTS idx_run_task_final_facts_attempt;
DROP INDEX IF EXISTS idx_run_task_final_facts_task;
DROP INDEX IF EXISTS idx_run_task_final_facts_run_id_id;
...
DROP INDEX IF EXISTS idx_external_identities_provider;
DROP INDEX IF EXISTS idx_external_identities_local_user;
...
DROP INDEX IF EXISTS idx_retention_holds_expires_at;
DROP INDEX IF EXISTS idx_retention_holds_active;
DROP INDEX IF EXISTS idx_retention_holds_scope_target;
...
DROP TABLE IF EXISTS reaction_local_messages;
DROP TABLE IF EXISTS reaction_invocations;
DROP TABLE IF EXISTS reaction_subscriptions;
DROP TABLE IF EXISTS reaction_targets;
DROP TABLE IF EXISTS reaction_events;
DROP TABLE IF EXISTS run_dispatch_events;
DROP TABLE IF EXISTS scm_trigger_events;
...
DROP TABLE IF EXISTS run_task_final_facts;
